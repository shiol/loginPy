...
userlabel = Label(rightframe, text="user:", font=("Arial", 20), background="gray", foreground="white")
userlabel.place(x=10, y=10)

userentry = ttk.Entry(rightframe, width=30)
userentry.place(x=100, y=20)

passwordlabel = Label(rightframe, text="password:", font=("Arial", 20), background="gray", foreground="white")
passwordlabel.place(x=10, y=100)

passwordentry = ttk.Entry(rightframe, width=30,show="*")
passwordentry.place(x=10, y=140)
